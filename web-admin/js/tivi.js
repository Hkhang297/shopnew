let Dia_chi_Img='https://res.cloudinary.com/df0xtqr92/image/upload/v1/images';
...
const showModal = (item = null) => {
    let urlImg = null;
    let Nhom = "";
    document.querySelector("#ModalTitle").innerHTML = `Insert Tivi`;
    if (item) {
        document.querySelector("#ModalTitle").innerHTML = `Update Tivi`;
    ...
    <div class="form-group">
        <label for="Th_Ten">Name</label>
        <input type="text" class="form-control" id="Th_Ten" 
            placeholder="Name" value="${item ? item.Ten : ''}">
    </div>
    <div class="form-group">
        <label for="Th_Don_gia_Nhap">Entry Price</label>
        <input type="number" class="form-control" id="Th_Don_gia_Nhap" 
            placeholder="Entry Price" value="${item ? item.Don_gia_Nhap : ''}">
    </div>
    <div class="form-group">
        <label for="Th_Don_gia_Ban">Retail Price</label>
        <input type="number" class="form-control" id="Th_Don_gia_Ban" 
            placeholder="Retail Price" value="${item ? item.Don_gia_Ban : ''}">
    </div>
    <div class="form-group">
        <label for="Th_Nhom_Tivi">Group Tivi</label>
        <select id="Th_Nhom_Tivi">
            ...
            <option value="KHAC" ${Nhom == 'KHAC' ? 'selected' : ''}>KHÁC</option>
        </select>
    </div>
    <div class="form-group">
        <label for="Th_File">Picture</label>
